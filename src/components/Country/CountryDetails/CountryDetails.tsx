  ...
  return (
    <>
      ...
      <div className="pt-20 h-screen w-screen bg-white border-gray-200 dark:bg-gray-800 transition duration-300">
        {!isLoading && (
          <div
            className="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800 transition duration-300"
            id="about"
            role="tabpanel"
          ...
          >
            ...
            <img
              ...
              alt="No Image"
            />
            <h2 className="mb-3 font-extrabold tracking-tight text-gray-900 dark:text-white">
            ...
            <p className="mb-3 text-gray-500 dark:text-gray-400">
              One death per one million: {countryData?.oneDeathPerPeople}
            </p>
            <p className="mb-3 text-gray-500 dark:text-gray-400">
            ...
            <p className="mb-3 text-gray-500 dark:text-gray-400">
              Test per one million: {countryData?.testsPerOneMillion}
            </p>
          </div>
        )}
